...
namespace NestLogger.Controllers
{
    public class ThermostateReadingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DateTime,RoomTemperature,TargetTemperature")] ThermostateReading thermostateReading)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DateTime,RoomTemperature,TargetTemperature")] ThermostateReading thermostateReading)
        {
            if (ModelState.IsValid)
            {
